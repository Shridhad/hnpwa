...
export const ColumnBaseMixin = superClass => class ColumnBaseMixin extends superClass {
  ...
  static get observers() {
    return ['_widthChanged(width, _headerCell, _footerCell, _cells.*)', '_frozenChanged(frozen, _headerCell, _footerCell, _cells.*)', '_flexGrowChanged(flexGrow, _headerCell, _footerCell, _cells.*)', '_orderChanged(_order, _headerCell, _footerCell, _cells.*)', '_lastFrozenChanged(_lastFrozen)', '_stampBodyTemplate(_bodyTemplate, _cells, _cells.*)', '_stampHeaderTemplate(_headerTemplate, _headerCell)', '_stampFooterTemplate(_footerTemplate, _footerCell)', '_resizableChanged(resizable, _headerCell)', '_reorderStatusChanged(_reorderStatus, _headerCell, _footerCell, _cells.*)', '_hiddenChanged(hidden, _headerCell, _footerCell, _cells.*)'];
  }
  /** @protected */
