...
export const RowDetailsMixin = superClass => class RowDetailsMixin extends superClass {
  ...
  static get observers() {
    return ['_detailsOpenedItemsChanged(detailsOpenedItems.*, dataProvider, _rowDetailsTemplate, _physicalCountVal)', '_rowDetailsTemplateChanged(_rowDetailsTemplate)'];
  }
    ...
    if (rowDetailsTemplate) {
      ...
      if (this._columnTree) {
        ...
        Array.from(this.$.items.children).forEach(row => {
          ...
          this._updateRow(row, this._columnTree[this._columnTree.length - 1]); // Clear any old template instances
